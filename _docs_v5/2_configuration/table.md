...
Table definition files define the binary tables that can be displayed in COSMOS [Table Manager]({{site.baseurl}}/docs/v5/table-manager)
...
The Table definition files share a lot of similarity with the [Command Configuration]({{site.baseurl}}/docs/v5/command). You have the same data types: INT, UINT, FLOAT, STRING, BLOCK. These correspond to integers, unsigned integers, floating point numbers, strings and binary blocks of data.
